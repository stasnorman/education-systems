...
class Event
{
    ...
    public static function getProductById($id)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT * FROM `eventstudy` WHERE id = :id';
    ...
    public static function getTotalProductsInCategory($categoryId)
    {
        ...
        // Текст запроса к БД
        $sql = 'SELECT count(id) AS count FROM `eventstudy` WHERE status="1" AND category_id = :category_id';
    ...
    public static function getProdustsByIds($idsArray)
    {
        ...
        // Текст запроса к БД
        $sql = "SELECT * FROM `eventstudy` WHERE status='1' AND id IN ($idsString)";
    ...
    public static function getRecommendedProducts()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name, brand, description, is_new FROM `eventstudy` '
    ...
    public static function getProductsList()
    {
        ...
        // Получение и возврат результатов
        $result = $db->query('SELECT id, name FROM `eventstudy` ORDER BY id ASC');
        $productsList = array();
        $i = 0;
        while ($row = $result->fetch()) {
            $productsList[$i]['id'] = $row['id'];
    ...
    public static function deleteProductById($id)
    {
        ...
        // Текст запроса к БД
        $sql = 'DELETE FROM `eventstudy` WHERE id = :id';
